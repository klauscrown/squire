...
const SHORTCUTS = [
  { id: 'names', icon: Sparkles, label: 'Gerar nomes', color: '#A78BFA', bg: 'rgba(139, 92, 246, 0.16)' },
  { id: 'items', icon: Package, label: 'Gerar itens', color: '#60A5FA', bg: 'rgba(59, 130, 246, 0.16)' },
  { id: 'notes', icon: NotebookPen, label: 'Notas Rápidas', color: '#818CF8', bg: 'rgba(99, 102, 241, 0.16)' },
  { id: 'encounter', icon: Dice6, label: 'Gerar Encontro', color: '#C084FC', bg: 'rgba(168, 85, 247, 0.16)' },
] as const;
